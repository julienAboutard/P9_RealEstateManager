...
import com.example.realestatemanager.ui.map.bottom_sheet.MapBottomSheetFragment
        ...
        viewModel.viewState.observe(viewLifecycleOwner) { viewState ->
            ...
            viewState.estateMarkers.forEach { markerViewState ->
                val marker = MarkerOptions()
                    ...
                    .icon(if (markerViewState.isSold) customMarkerIconSold else customMarkerIcon)
